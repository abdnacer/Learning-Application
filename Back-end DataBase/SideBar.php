    ...
    <div class="list-group list-group-flush">
        <div class="pt-1 d-flex justify-content-center">
          ...
          <div class="mt-3 d-flex justify-content-center">
            <a href="Dashbord_Courses.php" class="fs-5 text-center text-decoration-none text-dark pt-1 pb-1 pe-5 ps-4 rounded-3
            <?php if(basename($_SERVER['REQUEST_URI'])=="Dashbord_Courses.php"){echo "bg-info";}else{echo"bg-transparent";};?>">
